<p align="center">
    <img src="https://github.com/dark-pine/dark-pine-theme/raw/main/assets/icon.png" width="80" />
...
<p align="center">
    <a href="https://github.com/dark-pine/dark-pine-theme">
...
Install `dark-pine/neovim` using your favourite plugin manager:

**paq-nvim**

```lua
{ "dark-pine/neovim", as = "dark-pine" }
```

**lazy.nvim**

```lua
{ "dark-pine/neovim", name = "dark-pine" }
```
...
-- vim.cmd("colorscheme dark-pine-main")
-- vim.cmd("colorscheme dark-pine-moon")
-- vim.cmd("colorscheme dark-pine-dawn")
```

> [!NOTE]
> Visit the [wiki](https://github.com/dark-pine/neovim/wiki) for [plugin configurations](https://github.com/dark-pine/neovim/wiki/Plugin-configurations) and [recipes](https://github.com/dark-pine/neovim/wiki/Recipes).
...
Feel free to update the [wiki](https://github.com/dark-pine/neovim/wiki/) with any [recipes](https://github.com/dark-pine/neovim/wiki/Recipes).
